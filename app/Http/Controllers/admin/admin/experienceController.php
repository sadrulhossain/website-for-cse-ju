...
class experienceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.admin.experience.experiencelist', compact('experiences', 'teacher', 'designations'));
    }
    ...
    public function create()
    {
        $teacher = teacher::where('email', '=', Auth::user()->email)->first();
        $designations = teacher_designation::all();
        return view('admin.admin.experience.experience', compact('teacher', 'designations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin_experience.index'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.admin.experience.edit', compact('teacher', 'designations', 'experience'));
    }
