...
class journalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.admin.journal.journallist', compact('journals', 'teacher', 'designations', 'jtypes'));
    }
    ...
    public function create()
    {
        ...
        $designations = teacher_designation::all();
        $jtypes = journal_type::all();
        return view('admin.admin.journal.journal', compact('teacher', 'designations', 'jtypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin_journal.index'));
    }
    ...
    public function edit($id)
    {
        ...
        $jtypes = journal_type::all();
        return view('admin.admin.journal.edit', compact('teacher', 'designations', 'journal', 'jtypes'));
    }
