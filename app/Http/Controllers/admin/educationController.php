...
class educationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.education.educationlist', compact('educations', 'teacher', 'designations'));
    }
    ...
    public function create()
    {
        $teacher = teacher::where('email', '=', Auth::user()->email)->first();
        $designations = teacher_designation::all();
        return view('admin.education.education', compact('teacher', 'designations'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.education.edit', compact('teacher', 'designations', 'education'));
    }
