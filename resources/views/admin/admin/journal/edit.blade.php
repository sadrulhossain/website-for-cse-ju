        ...
        <section class="content">
                <div class="row">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="box box-primary">
                                        ...
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form role="form" action="{{route('admin_journal.update', $journal->id)}}" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                {{method_field('PUT')}}
                                                <div class="box-body">
                                                        <div class="col-lg-6">
                ...
                <small>A detailed description about upcoming journal</small>
                                        ...
                                        <div class="box-footer form-group">
                                                <a href="{{route('admin_journal.index')}}" class="btn btn-primary">Back</a>
