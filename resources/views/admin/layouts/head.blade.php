...
<title>CSE-JU Admin | @yield('title')</title>
<link rel="icon" href="{{asset('public/image/ju_logo.png')}}">
...
<!-- jvectormap -->
<link rel="stylesheet" href="{{asset('public/admin/public/admin/bower_components/jvectormap/jquery-jvectormap.css')}}">
<!-- Date Picker -->
